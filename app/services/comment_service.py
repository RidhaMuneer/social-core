...
def get_comments_service(id: int, db: Session):
    comments_with_users = (
...
def create_comment_service(comment: CommentSchema, db: Session, current_user: UserSchema):
...
def delete_comment_service(id: int, db: Session, current_user: UserSchema):
